...
public class TwoArrayAscendingOrder {
	...
	public static void main(String[] args) {
	    ...
	    for (int i = 0; i < c.length; i++) {
	        ...
	        if (j < a.length && k < b.length) {
	            ...
	            System.out.println("the value of k inside for is  "+k );
	            System.out.println("the value of j inside for is  "+j );
	        }
	        ...
	        System.out.println("the value of k interoutside for is  "+k );
	        System.out.println("the value of j interoutside for is  "+j );
	    }
	    System.out.println("the value of k outside for is  "+k );
        System.out.println("the value of j outside for is  "+j );
	    for(int i = 0; i < c.length; i++)
